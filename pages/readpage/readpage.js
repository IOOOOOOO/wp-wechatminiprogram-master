...
Page({
  ...
  onPullDownRefresh: function() {
    var self = this;
    var postids = self.data.myPostid;
    self.setData({
      display: 'none',
      pageData: {},
      wxParseData: {},
  ...
  onShareAppMessage: function() {
    return {
      title: config.getWebsiteName + '视音频节目链接',
      path: 'pages/readpage/readpage?postid=' + self.data.pageData.id,
