...
var DOMAIN = "www.dadread.com";
var MINAPPTYPE="1";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="宝宝花园"; //网站名称
...
var REPLAYTEMPPLATEID = 'J1oV2tbncswJO7WeI3duHf-Kf494q53CYlVjz6idxxc';//回复评论消息模版id
var ZANIMAGEURL = 'https://www.dadread.com/wp-content/uploads/2019/02/2019020813244533.jpg';//微信鼓励的图片链接，用于个人小程序的赞赏
...
var DOWNLOADFILEDOMAIN = [
    { id: 1, domain: 'www.dadread.com' },
    { id: 2, domain: 'oss.dadread.com' },
    { id: 3, domain: 'www.dadread.com' }
];
 //首页图标导航
...
var INDEXNAV = [
  { id: '1', name: '听故事', icon: 'musicfill', color: 'cyan', badge: 0, url: '../readpage/readpage?postid=109', redirecttype: 'apppage', appid: '', extraData: '' },
  { id: '2', name: '领读绘本', icon: 'record', color: 'yellow', badge: 0, url: '../readpage/readpage?postid=114', redirecttype: 'apppage', appid: '', extraData: '' },
  // { id: '3', name: '阅读助手', icon: 'command', color: 'cyan', badge: 0, url: 'pages/index/index', redirecttype: 'miniapp', appid: '	wx57d04dc2e8057050', extraData: '' },
  { id: '4', name: 'Top热文', icon: 'hot', color: 'red', badge:0, url: '../hot/hot', redirecttype: 'apppage', appid: '', extraData: ''},
  // { id: '5', name: '微店', icon: '../../images/nav-icon5.png', url: 'pages/shelf/shelf', redirecttype: 'miniapp', appid: 'wx55ea6098e41af5c4', extraData: ''}
  { id: '6', name: '关于', icon: 'info', color: 'orange', badge: 0,url: '../about/about', redirecttype: 'apppage', appid: '', extraData: ''}
